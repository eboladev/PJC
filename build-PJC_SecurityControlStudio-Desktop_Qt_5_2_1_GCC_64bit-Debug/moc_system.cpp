...
#include "../PJC_SecurityControlStudio/system.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_System_t, stringdata) + ofs \
...
QT_MOC_LITERAL(5, 31, 7)
    ...
    "System\0ssendData\0\0address\0data\0getData\0"
};
...
void System::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->ssendData((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        ...
        {
            typedef void (System::*_t)(int , int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&System::ssendData)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void System::ssendData(int _t1, int _t2)
{
